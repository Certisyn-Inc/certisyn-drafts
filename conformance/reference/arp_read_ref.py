...
# The encoder itself lives in arp_cbor.py so that a runner testing it need not
# import this module and, through it, `cryptography`. Re-exported here under
# the names the rest of this file and the other runners already use.
from arp_cbor import _head, cbor            # noqa: E402  (see HERE below)
